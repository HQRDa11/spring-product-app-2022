package fr.greta91.springProductApp.config;
...
import fr.greta91.springProductApp.filters.JwtTokenAuthFilter;
...
//			.mvcMatchers(HttpMethod.POST, "/api/produit/**").permitAll()
